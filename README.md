...
// `OxKvStore::builder().with_object_store(s3).with_prefix(...)`
...
```toml
[dependencies]
oxkv = { version = "0.4", features = ["oxkv"] }           # portable LSM core
# oxkv = { version = "0.4", features = ["oxkv", "oxkv-s3"] } # + S3/GCS/Azure via object_store (native)
```
